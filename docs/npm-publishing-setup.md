# NPM Publishing Setup for job-finder-shared-types
...
3. Check [npmjs.com](https://www.npmjs.com/package/@jsdubzw/job-finder-shared-types) to verify the package was published
...
- **Package Name**: `@jsdubzw/job-finder-shared-types`
- **Current Version**: `1.1.0`
- **npm Registry**: https://www.npmjs.com/package/@jsdubzw/job-finder-shared-types
...
```bash
npm install @jsdubzw/job-finder-shared-types
```
