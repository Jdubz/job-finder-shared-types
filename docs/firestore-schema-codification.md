...
Successfully codified the complete Firestore database schema from the production (portfolio) database into TypeScript interfaces in the `@jsdubzw/job-finder-shared-types` package.
...
```typescript
import { CompanyDocument, CompanyTier } from "@jsdubzw/job-finder-shared-types";
...
- **NPM Package:** https://www.npmjs.com/package/@jsdubzw/job-finder-shared-types
